...
import { ContaController } from "./src/util/controller/ContraController";
...
function sobre(): void {
    console.log("\n*****************************************************");
    console.log("Projeto Desenvolvido por: Gabrielle De Castro Alves");
    console.log("gabrielledecastro2320@gmail.com");
    console.log("https://github.com/gabrielleclvs");
    console.log("*****************************************************");
}
